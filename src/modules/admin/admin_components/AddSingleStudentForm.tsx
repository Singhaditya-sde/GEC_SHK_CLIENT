...
export function AddSingleStudentForm() {
  ...
  function handleChange(e: React.ChangeEvent<HTMLInputElement | HTMLSelectElement>) {
    ...
    setFormData((prev) => ({
      ...prev,
      [name]:
        name === 'deptId' || name === 'semId' || name === 'batchId'
          ? Number(value)
          : type === 'checkbox'
  ...
  return (
    <div className="px-5">
      ...
      <div className="bg-white  p-5 mt-5 rounded-xl mb-5">
        <div className="flex justify-between items-center">
          ...
          <div className="mt-3 flex flex-col ">
            ...
            <div className="grid grid-cols-3 gap-6 mt-2">
              ...
              <div className="flex flex-col gap-1.5">
                ...
                {errors.semId && <p className="text-red-500 text-xs mt-1">{errors.semId}</p>}
              </div>
              <div className="flex flex-col gap-1.5">
                <label className="text-sm font-medium text-[#334155]">
              ...
              <div className="flex flex-col gap-1.5">
                ...
                {errors.admissionType && (
                  <p className="text-red-500 text-xs mt-1">{errors.admissionType}</p>
                )}
              </div>
              <div className="flex flex-col gap-1.5">
                <label className="text-sm font-medium text-[#334155]">
            ...
            <div className="grid grid-cols-2 gap-6 mt-2">
              ...
              <div className="flex flex-col gap-1.5">
                ...
                {errors.parentPhoneNo && (
                  <p className="text-red-500 text-xs mt-1">{errors.parentPhoneNo}</p>
                )}
              </div>
            </div>
