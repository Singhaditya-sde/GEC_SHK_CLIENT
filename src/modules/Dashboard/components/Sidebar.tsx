...
const SideBarMenu: SideBarMenuProp[] = [
  ...
  { title: "Faculty", path: "/admin/faculty", icon: GraduationCap },
  { title: "Departments", path: "/admin/departments", icon: Building2 },
  { title: "Directory", path: "/admin/directory", icon: BookUser },
];

export function Sidebar() {
  return(
    <>
      <div className="flex flex-col justify-between w-64 h-screen border-r border-gray-300">
        <div>
